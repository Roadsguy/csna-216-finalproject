...
namespace FinalProject.prescriptions
{
	public partial class _default : BasePage
	{
		...
		// Create instance of user control classes
		...
		public void LoadUserControl(string pageType, string cipherRxNo)
		{
			string controlURL = "";
			switch (pageType) // Check which page type is being loaded
			{
				...
				case "add":
					...
					controlURL = "/prescriptions/prescriptions_vieweditadd.ascx";
					...
					break;
				case "refill-auto":
					// Set refill vieweditadd control to be loaded
			...
			ucCurrent.PrimaryKey = cipherRxNo;									// Pass Rx No.
			...
			{
				case "view":
					ucCurrent.RefillClicked += new CommandEventHandler(Load_Refill);
					goto case "edit";
				case "edit":
				case "add":
				case "refill-auto":
				...
				default:
					...
					// Create event handlers for View, Edit, and Refill buttons to load respective pages
		...
		protected void Load_Refill(object sender, CommandEventArgs e)
		{
			// Load refill vieweditadd control with PageType add-auto and Rx. No from CommandEventArgs
			LoadUserControl("refill-auto", e.CommandArgument.ToString());
		}
