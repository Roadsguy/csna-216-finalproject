...
namespace FinalProject.physicians
{
	public partial class _default : BasePage
	{
		...
		public void LoadUserControl(string pageType, string cipherPhysicianID)
		{
			string controlURL = "";
			switch (pageType) // Check which page type is being loaded
			{
				...
				case "add":
					...
					controlURL = "/physicians/physicians_vieweditadd.ascx";
				...
				default:
					...
					controlURL = "/physicians/physicians_search.ascx";
					pageType = "search";
					ViewState["pageType"] = pageType;
					break;
			}
			...
			ucCurrent.PrimaryKey = cipherPhysicianID;                             // Pass patient ID
